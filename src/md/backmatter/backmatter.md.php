...
body {
  ...
  font-size: 1.2em;
  color:#000000 //#c5c8c6;
  background-color:#ffffff //#1d1f21;
  overflow: auto;
}
body > :first-child,
...
.my-endnotes{padding-top:8px;line-height:1.28;}
.endnotebold{float:left;font-weight:bold;clear:left;padding-right:5px;font-size:0.8;}
.endnotebold a{padding-left:8px;}

</style>

  </head>
  <body>
    <div id="prince_anchor_back_matter"></div>
<pre><?php include('glossary.md');?> </pre>
<pre><?php include('endnotes.md');?> </pre>
<pre><?php include('index.md');?></pre>
